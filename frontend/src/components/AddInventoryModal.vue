                        ...
                        <div class="px-6 py-4 flex flex-col gap-8">
                            <div class="flex flex-row gap-4 items-center">
                                <div class="form-group">
                                    ...
                                    <input v-model="addParty.name" type="text" class="form-control" placeholder="Enter Customer Name" required>
                                </div>
                                <div class="form-group">
                                    <label for="">Address</label>
                                    <input v-model="addParty.address" type="text" class="form-control" placeholder="Enter Customer Address" required>
                                </div>
                            </div>
                            <div class="flex flex-row gap-4 items-center">
                                <div class="form-group">
                                    <label for="">Contact</label>
                                    <input v-model="addParty.contact" type="tel" class="form-control" placeholder="Enter Customer Contact" required>
                                </div>
                                <div class="form-group">
                                    <label for="">Email</label>
                                    <input v-model="addParty.email" type="email" class="form-control" placeholder="Enter Customer Email" required>
                                </div>
                            </div>            
                        </div>
